...
- Name: ADD_ON_loan.spec.js >> Block 6 — Input Validation & UI State >> TC-LOAN-19 | Loan amount input can be cleared and re-entered
- Location: tests/ADD_ON_loan.spec.js:161:3
